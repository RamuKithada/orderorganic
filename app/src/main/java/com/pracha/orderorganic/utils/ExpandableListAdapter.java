...
class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, "Name" + childText.getTitle() + "ID" + childText.getMy_id(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (isExpanded) {
            ivGroupIndicator.setImageResource(R.drawable.ic_remove_black_24dp);
        } else {
            ivGroupIndicator.setImageResource(R.drawable.ic_add_black_24dp);
        }
