...
public class HomePageDetails {
    ...
    @SerializedName("categorywiseproductlistdfdfs")
    @Expose
    private Categorywiseproductlist categorywiseproductlist;
    ...
    public Categorywiseproductlist getCategorywiseproductlist() {
        return categorywiseproductlist;
    }

    public void setCategorywiseproductlist(Categorywiseproductlist categorywiseproductlist) {
